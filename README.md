# Table Pro Layout for Directus

A pro table layout that allows you to edit item fields directly inline, just like in a spreadsheet.

## Installation & Setup

To install the extension, take a look at the [Official Guide](https://docs.directus.io/extensions/installing-extensions.html).

Once installed, go to your collection page, on the `Layout Options` tab in the sidebar, select `Table Pro` from the `Layout` drop-down list.
